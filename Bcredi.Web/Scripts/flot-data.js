...
//Flot Pie Chart
$(function() {
    //SOMATORIO DA PORCENTAGEM TEM QUE DAR 33, MODIFICAR ESSA PARTE SE PRECISAR
    var data = [{
        label: "&nbsp;&nbsp;Notificação - 139",
        data: 18
    }, {
        label: "&nbsp;&nbsp;Leilão - 94",
        data: 15
...
$(function () {
    //SOMATORIO DA PORCENTAGEM TEM QUE DAR 33, MODIFICAR ESSA PARTE SE PRECISAR
    var data = [{
        label: "&nbsp;&nbsp;Até 20 dias LTV médio",
        data: 20
    }, {
        label: "&nbsp;&nbsp;Até 8 dias LTV médio",
        data: 8
    }, {
        label: "&nbsp;&nbsp;Até 6 dias LTV médio",
        data: 6
        //}, {
        //    label: "Series 2",
        //    data: 9
    ...
    var plotObj = $.plot($("#flot-pie-chart-3"), data, {
        series: {
            pie: {
                show: true
            }
