...
(function( $ ){
	...
	var methods = {
		...
		init : function( options )
		{
			...
			var styles = {  "Cabe&ccedil;alho 1":"<h1>",
							"Cabe&ccedil;alho 2":"<h2>",
							"Cabe&ccedil;alho 3":"<h3>",
							"Cabe&ccedil;alho 4":"<h4>",
							"Cabe&ccedil;alho 5":"<h5>",
							"Cabe&ccedil;alho 6":"<h6>",
							"Paragr&aacute;fo":"<p>" };
		    ...
		    $(document.body).mousedown(function(event) {
                ...
                //25/02/2017 - Marcelo - Comentado porque estava com conflito no MS TECH
                /*
